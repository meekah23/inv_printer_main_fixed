...
def getData(self):
        try:
            ...
            cur.execute("SELECT OQDATE,OSLSMAN,ADDEDBY,OQNO, OPONO, ORDATE FROM prq_hd WHERE PR_STATUS = ''")
            result = cur.fetchall()
            ...
            #get ship details
            cur.execute("SELECT ONAME||COALESCE(OFNAME,' '),OADDR1, OADDR2,OADDR3,OPCODE,OBPHONE,OPSTNO,OSTREET,OINAME,OIADDR1,OIADDR2,OIADDR3,OIPCODE FROM prq_hd WHERE  PR_STATUS = ''")
            ...
            cur.execute("SELECT OD_ITEM, "
                       ...
                       "FROM prq_det "
                        ...
                        "WHERE prq_hd.PR_STATUS = '' "
                        "ORDER BY prq_det.ADDEDBY02 ASC, prq_det.OD_LINE ASC")
            table = cur.fetchall()
...
def toPDF(self):
        ...
        try:
            ...
            for data, sumamt, ogst, ototal, odate, osale, oadd, oquo, opono,ordate,oname, osadd1, osadd2, osadd3, oscode, osphone, ospstno, olstr, olname, oladd1, oladd2, oladd3, olcode in zip(all_data, amt, gst, total, date, saleman,addedby,quote, po,datereq,name, sadd1, sadd2, sadd3, scode, sphone, spstno, lstreet, lname, ladd1, ladd2, ladd3, lcode):
                ...
                save_name = os.path.join("Printer Main Files/Main PDF Files/", "q"+ str(oquo)+'.pdf')           
            ...
            try:               
               opentable = dbf.Table('Printer Main Files/Main Data/prq_hd.dbf')
